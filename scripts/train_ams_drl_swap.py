...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--minimal_log", action="store_true",
                   help="터미널 'Mean episode {*}' extras print skip. wandb 기록은 그대로. "
...
def main() -> int:   # noqa: PLR0912 — orchestrator drives 3-phase per-cycle loop
    ...
    # 2026-05-13 — run_name prefix: cli --wandb_project. 자식 cmd에 cycle/round 정보
    # 합쳐 forward. 예: ams_drl_v6_attacker_cycle_2_round_1
